...
class RoverState():
    def __init__(self):
        ...
        self.throttle_set = 0.2 # Throttle setting when accelerating  0.2
        self.brake_set = 15 # Brake setting when braking 10
        ...
        self.max_vel = 2.5 # Maximum velocity (meters/second) 2
